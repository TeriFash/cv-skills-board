...
class Academics extends Component{
  render(){
    return(
      ...
      <p>And last year I did two courses, one of React JS and React Native on <a href="#" className="App-Link academy">Hack Academy</a>, a well known IT academy from Uruguay, and the other one of Videogame Design with Unreal Engine 4 at <a href="#" className="App-Link academy">Senpai Academy</a>.</p>
      </div>
    );
  }
}
